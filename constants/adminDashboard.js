...
const ADMINDASHBOARD = {
  ...
  items: [
    ...
    {
      id: 7,
      label: "Total number of counsellors",
      abbr: "Total counsellors",
      icon: DirectionsRunIcon,
      value: 10,
    },
    {
      id: 8,
      label: "Total number of counsellees",
      abbr: "Total counsellees",
      icon: DirectionsWalkIcon,
      value: 10,
    },
    {
      id: 9,
      label: "Total number of payments today",
      abbr: "Payments (today)",
      icon: PaymentIcon,
      value: 10,
    },
    {
      id: 10,
      label: "Total sum of payments today",
      abbr: "Payments sum (today)",
      icon: AddCardIcon,
      value: 10,
    },
    {
      id: 11,
      label: "Total sum of payments this month",
      abbr: "Payments sum (month)",
      icon: AddBusinessIcon,
      value: 10,
    },
    {
      id: 12,
      label: "Total number of site visitors this month",
      abbr: "Visitors (month)",
      icon: VisibilityIcon,
      value: 10,
    },
    {
      id: 13,
      label: "Total number of site visitors today",
      abbr: "Visitors (today)",
      icon: GroupIcon,
      value: 10,
    },
    {
      id: 14,
      label: "Total sum of active customers",
      abbr: "Active customers",
    ...
    {
      id: 17,
      label: "App ratings this week",
      abbr: "App ratings (week)",
      icon: StarIcon,
      value: 10,
    },
    {
      id: 18,
      label: "Number of complaints today",
      abbr: "Complaints (today)",
      icon: SentimentDissatisfiedIcon,
      value: 10,
    },
    {
      id: 19,
      label: "Number of complaints resolved today",
      abbr: "Complaints resolved (today)",
    ...
    {
      id: 23,
      label: "Number of pending payments",
      abbr: "Pending payments",
